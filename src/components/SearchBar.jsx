...
export default function SearchBar({ onCountrySelect, selectedCountry }) {
  ...
  return (
    <div className="fixed top-[21px] left-[21px] z-50 search-container" onClick={(e) => e.stopPropagation()}>
      <div className="relative">
        ...
        <input
          ...
          className="w-[200px] pl-10 pr-4 py-2 rounded-xl bg-[#140100]/60 backdrop-blur-sm border border-[#F8D557]/30 text-[#F8D557] placeholder-[#F8D557]/50 focus:outline-none focus:border-[#F8D557]/70 focus:ring-0"
        />
      </div>

      {showResults && filteredCountries.length > 0 && (
        <div className="absolute top-full left-0 mt-1 w-[200px] max-h-[300px] overflow-y-auto rounded-xl bg-[#140100] border border-[#F8D557]/30 scrollbar-hide" onClick={(e) => e.stopPropagation()}>
